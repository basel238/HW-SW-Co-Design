# Start here — complete v4 repository package

For an existing Git repository, use MIGRATION.md first. For a standalone run, extract the whole directory into your Ubuntu VM. Keep the same release Python version as before; Python 3.12/3.13 is not required for the main workflow.

```bash
cd project-repo-v4.1
